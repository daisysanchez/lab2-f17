...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 cb 77 10 80 	movl   $0x801077cb,(%esp)
...
80100b72:	0f 84 91 01 00 00    	je     80100d09 <exec+0x369>
...
80100bef:	e8 cc 60 00 00       	call   80106cc0 <copyout>
...
80100c6d:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c73:	e8 48 60 00 00       	call   80106cc0 <copyout>
...
80100cee:	e8 cd 58 00 00       	call   801065c0 <switchuvm>
  freevm(oldpgdir);
80100cf3:	89 34 24             	mov    %esi,(%esp)
80100cf6:	e8 45 5c 00 00       	call   80106940 <freevm>
  return 0;
...
80100d04:	e9 09 fd ff ff       	jmp    80100a12 <exec+0x72>
  for(argc = 0; argv[argc]; argc++) {
80100d09:	bb ff ff ff 7f       	mov    $0x7fffffff,%ebx
80100d0e:	31 d2                	xor    %edx,%edx
80100d10:	8d 8d 58 ff ff ff    	lea    -0xa8(%ebp),%ecx
80100d16:	e9 12 ff ff ff       	jmp    80100c2d <exec+0x28d>
...
80100d35:	e8 16 33 00 00       	call   80104050 <initlock>
}
80100d3a:	c9                   	leave  
80100d3b:	c3                   	ret    
...
80100d53:	e8 e8 33 00 00       	call   80104140 <acquire>
...
80100d79:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      release(&ftable.lock);
80100d80:	e8 ab 34 00 00       	call   80104230 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100d97:	e8 94 34 00 00       	call   80104230 <release>
}
...
80100dc1:	e8 7a 33 00 00       	call   80104140 <acquire>
  if(f->ref < 1)
...
80100dda:	e8 51 34 00 00       	call   80104230 <release>
  return f;
}
...
80100e13:	e8 28 33 00 00       	call   80104140 <acquire>
  if(f->ref < 1)
...
80100e3a:	5d                   	pop    %ebp
    release(&ftable.lock);
80100e3b:	e9 f0 33 00 00       	jmp    80104230 <release>
  ff = *f;
...
80100e5c:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100e5f:	e8 cc 33 00 00       	call   80104230 <release>
  if(ff.type == FD_PIPE)
...
801011c8:	e8 b3 30 00 00       	call   80104280 <memset>
  log_write(bp);
...
80101209:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
8010120c:	e8 2f 2f 00 00       	call   80104140 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
80101246:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
80101249:	e8 e2 2f 00 00       	call   80104230 <release>
  ip->ref = 1;
  ip->valid = 0;
  release(&icache.lock);
...
8010128e:	e8 9d 2f 00 00       	call   80104230 <release>
}
...
801013a2:	e8 79 2f 00 00       	call   80104320 <memmove>
  brelse(bp);
...
8010146b:	e8 e0 2b 00 00       	call   80104050 <initlock>
...
80101480:	80 
80101481:	e8 ba 2a 00 00       	call   80103f40 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
80101589:	e8 f2 2c 00 00       	call   80104280 <memset>
      dip->type = type;
...
8010163f:	00 
80101640:	e8 db 2c 00 00       	call   80104320 <memmove>
  log_write(bp);
...
80101671:	e8 ca 2a 00 00       	call   80104140 <acquire>
  ip->ref++;
80101676:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010167a:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101681:	e8 aa 2b 00 00       	call   80104230 <release>
}
...
801016b4:	e8 c7 28 00 00       	call   80103f80 <acquiresleep>
  if(ip->valid == 0){
...
8010172b:	e8 f0 2b 00 00       	call   80104320 <memmove>
    brelse(bp);
...
80101785:	e8 96 28 00 00       	call   80104020 <holdingsleep>
...
8010179d:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010179e:	e9 3d 28 00 00       	jmp    80103fe0 <releasesleep>
    panic("iunlock");
...
801017c2:	e8 b9 27 00 00       	call   80103f80 <acquiresleep>
...
801017d8:	e8 03 28 00 00       	call   80103fe0 <releasesleep>
  acquire(&icache.lock);
801017dd:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801017e4:	e8 57 29 00 00       	call   80104140 <acquire>
  ip->ref--;
...
801017fa:	5d                   	pop    %ebp
  release(&icache.lock);
801017fb:	e9 30 2a 00 00       	jmp    80104230 <release>
    acquire(&icache.lock);
80101800:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101807:	e8 34 29 00 00       	call   80104140 <acquire>
    int r = ip->ref;
8010180c:	8b 5e 08             	mov    0x8(%esi),%ebx
    release(&icache.lock);
8010180f:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101816:	e8 15 2a 00 00       	call   80104230 <release>
    if(r == 1){
...
801019e8:	e8 33 29 00 00       	call   80104320 <memmove>
    brelse(bp);
...
80101ae4:	e8 37 28 00 00       	call   80104320 <memmove>
    log_write(bp);
...
80101b8b:	e8 10 28 00 00       	call   801043a0 <strncmp>
}
80101b90:	c9                   	leave  
80101b91:	c3                   	ret    
...
80101c09:	e8 92 27 00 00       	call   801043a0 <strncmp>
      continue;
...
80101c88:	e8 b3 24 00 00       	call   80104140 <acquire>
  ip->ref++;
80101c8d:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101c91:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101c98:	e8 93 25 00 00       	call   80104230 <release>
...
80101cfb:	e8 20 26 00 00       	call   80104320 <memmove>
    path++;
...
80101d89:	e8 92 25 00 00       	call   80104320 <memmove>
    name[len] = 0;
...
80101e83:	e8 88 25 00 00       	call   80104410 <strncpy>
  de.inum = inum;
...
80101ff5:	e8 56 20 00 00       	call   80104050 <initlock>
...
80102070:	e8 cb 20 00 00       	call   80104140 <acquire>
...
801020b6:	e8 75 21 00 00       	call   80104230 <release>
...
80102110:	e8 0b 1f 00 00       	call   80104020 <holdingsleep>
...
80102146:	e8 f5 1f 00 00       	call   80104140 <acquire>
...
8010218b:	e8 70 1a 00 00       	call   80103c00 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
801021a5:	5d                   	pop    %ebp
  release(&idelock);
801021a6:	e9 85 20 00 00       	jmp    80104230 <release>
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
...
8010230a:	e8 71 1f 00 00       	call   80104280 <memset>
...
80102343:	5d                   	pop    %ebp
    release(&kmem.lock);
80102344:	e9 e7 1e 00 00       	jmp    80104230 <release>
80102349:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    acquire(&kmem.lock);
80102350:	c7 04 24 40 26 11 80 	movl   $0x80112640,(%esp)
80102357:	e8 e4 1d 00 00       	call   80104140 <acquire>
...
801023da:	e8 71 1c 00 00       	call   80104050 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801024ad:	e8 7e 1d 00 00       	call   80104230 <release>
  return (char*)r;
}
...
801024c7:	e8 74 1c 00 00       	call   80104140 <acquire>
...
8010287c:	e8 4f 1a 00 00       	call   801042d0 <memcmp>
...
801029a7:	e8 74 19 00 00       	call   80104320 <memmove>
...
80102a6a:	e8 e1 15 00 00       	call   80104050 <initlock>
  readsb(dev, &sb);
...
80102afd:	e8 3e 16 00 00       	call   80104140 <acquire>
...
80102b17:	e8 e4 10 00 00       	call   80103c00 <sleep>
    if(log.committing){
...
80102b45:	a3 bc 26 11 80       	mov    %eax,0x801126bc
      release(&log.lock);
80102b4a:	e8 e1 16 00 00       	call   80104230 <release>
      break;
    }
  }
}
...
80102b70:	e8 cb 15 00 00       	call   80104140 <acquire>
  log.outstanding -= 1;
...
80102ba8:	00 00 00 
  release(&log.lock);
80102bab:	e8 80 16 00 00       	call   80104230 <release>
  if (log.lh.n > 0) {
...
80102c0f:	e8 0c 17 00 00       	call   80104320 <memmove>
...
80102c54:	e8 e7 14 00 00       	call   80104140 <acquire>
    log.committing = 0;
...
80102c76:	e8 b5 15 00 00       	call   80104230 <release>
}
...
80102ccd:	e8 6e 14 00 00       	call   80104140 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102d1e:	5d                   	pop    %ebp
  release(&log.lock);
80102d1f:	e9 0c 15 00 00       	jmp    80104230 <release>
...
80102d9f:	e8 bc 0b 00 00       	call   80103960 <scheduler>
...
80102e25:	e8 26 3f 00 00       	call   80106d50 <shminit>
  tvinit();        // trap vectors
...
80102e56:	e8 c5 14 00 00       	call   80104320 <memmove>
  for(c = cpus; c < cpus+ncpu; c++){
...
80102f2b:	e8 a0 13 00 00       	call   801042d0 <memcmp>
...
80102fe6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80102fe9:	e8 e2 12 00 00       	call   801042d0 <memcmp>
...
801031c6:	80 
801031c7:	e8 84 0e 00 00       	call   80104050 <initlock>
  (*f0)->type = FD_PIPE;
...
80103251:	e8 ea 0e 00 00       	call   80104140 <acquire>
  if(writable){
...
8010328e:	5d                   	pop    %ebp
    release(&p->lock);
8010328f:	e9 9c 0f 00 00       	jmp    80104230 <release>
...
801032bb:	e8 70 0f 00 00       	call   80104230 <release>
    kfree((char*)p);
...
801032df:	e8 5c 0e 00 00       	call   80104140 <acquire>
  for(i = 0; i < n; i++){
...
8010333b:	e8 c0 08 00 00       	call   80103c00 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
80103362:	e8 c9 0e 00 00       	call   80104230 <release>
        return -1;
...
801033b2:	e8 79 0e 00 00       	call   80104230 <release>
  return n;
...
801033d2:	e8 69 0d 00 00       	call   80104140 <acquire>
...
801033ff:	e8 fc 07 00 00       	call   80103c00 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
8010342b:	e8 00 0e 00 00       	call   80104230 <release>
...
8010348d:	e8 9e 0d 00 00       	call   80104230 <release>
}
...
801034b3:	e8 88 0c 00 00       	call   80104140 <acquire>
...
801034ee:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
801034f1:	e8 3a 0d 00 00       	call   80104230 <release>
...
8010352a:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
8010352d:	e8 4e 0d 00 00       	call   80104280 <memset>
...
8010354f:	e8 dc 0c 00 00       	call   80104230 <release>
}
...
8010357d:	e8 ae 0c 00 00       	call   80104230 <release>
...
801035d5:	e8 76 0a 00 00       	call   80104050 <initlock>
}
801035da:	c9                   	leave  
801035db:	c3                   	ret    
...
80103646:	c7 04 24 24 74 10 80 	movl   $0x80107424,(%esp)
...
80103684:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103687:	e8 74 0a 00 00       	call   80104100 <pushcli>
  c = mycpu();
8010368c:	e8 4f ff ff ff       	call   801035e0 <mycpu>
  p = c->proc;
80103691:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103697:	e8 24 0b 00 00       	call   801041c0 <popcli>
}
...
801036cd:	0f 84 fd 00 00 00    	je     801037d0 <userinit+0x120>
...
80103707:	e8 74 0b 00 00       	call   80104280 <memset>
...
80103747:	c7 40 44 ff ff ff 7f 	movl   $0x7fffffff,0x44(%eax)
	p->tf->ebp = STACKBASE;
8010374e:	8b 43 18             	mov    0x18(%ebx),%eax
80103751:	c7 40 08 ff ff ff 7f 	movl   $0x7fffffff,0x8(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
80103758:	8b 43 18             	mov    0x18(%ebx),%eax
8010375b:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
	if(allocuvm(p->pgdir, PGROUNDDOWN(STACKBASE), STACKBASE) == 0){
80103762:	c7 44 24 08 ff ff ff 	movl   $0x7fffffff,0x8(%esp)
80103769:	7f 
8010376a:	c7 44 24 04 00 f0 ff 	movl   $0x7ffff000,0x4(%esp)
80103771:	7f 
80103772:	8b 43 04             	mov    0x4(%ebx),%eax
80103775:	89 04 24             	mov    %eax,(%esp)
80103778:	e8 a3 30 00 00       	call   80106820 <allocuvm>
8010377d:	85 c0                	test   %eax,%eax
8010377f:	74 5b                	je     801037dc <userinit+0x12c>
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103781:	8d 43 6c             	lea    0x6c(%ebx),%eax
80103784:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
8010378b:	00 
8010378c:	c7 44 24 04 72 73 10 	movl   $0x80107372,0x4(%esp)
80103793:	80 
80103794:	89 04 24             	mov    %eax,(%esp)
80103797:	e8 c4 0c 00 00       	call   80104460 <safestrcpy>
  p->cwd = namei("/");
8010379c:	c7 04 24 7b 73 10 80 	movl   $0x8010737b,(%esp)
801037a3:	e8 38 e7 ff ff       	call   80101ee0 <namei>
801037a8:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
801037ab:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801037b2:	e8 89 09 00 00       	call   80104140 <acquire>
  p->state = RUNNABLE;
801037b7:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
801037be:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801037c5:	e8 66 0a 00 00       	call   80104230 <release>
}
801037ca:	83 c4 14             	add    $0x14,%esp
801037cd:	5b                   	pop    %ebx
801037ce:	5d                   	pop    %ebp
801037cf:	c3                   	ret    
    panic("userinit: out of memory?");
801037d0:	c7 04 24 4c 73 10 80 	movl   $0x8010734c,(%esp)
801037d7:	e8 84 cb ff ff       	call   80100360 <panic>
		panic("panic proc.c");
801037dc:	c7 04 24 65 73 10 80 	movl   $0x80107365,(%esp)
801037e3:	e8 78 cb ff ff       	call   80100360 <panic>
801037e8:	90                   	nop
...
801037f8:	8b 75 08             	mov    0x8(%ebp),%esi
  struct proc *curproc = myproc();
801037fb:	e8 80 fe ff ff       	call   80103680 <myproc>
  if(n > 0){
...
80103819:	e8 02 30 00 00       	call   80106820 <allocuvm>
...
80103827:	e8 94 2d 00 00       	call   801065c0 <switchuvm>
  return 0;
...
801038c6:	74 0f                	je     801038d7 <fork+0x77>
      np->ofile[i] = filedup(curproc->ofile[i]);
801038c8:	89 04 24             	mov    %eax,(%esp)
801038cb:	e8 e0 d4 ff ff       	call   80100db0 <filedup>
...
801038dd:	75 e1                	jne    801038c0 <fork+0x60>
...
801038e8:	e8 73 dd ff ff       	call   80101660 <idup>
...
80103957:	c7 47 0c 00 00 00 00 	movl   $0x0,0xc(%edi)
    return -1;
8010395e:	eb ce                	jmp    8010392e <fork+0xce>
...
80103966:	83 ec 1c             	sub    $0x1c,%esp
  struct cpu *c = mycpu();
80103969:	e8 72 fc ff ff       	call   801035e0 <mycpu>
...
80103a08:	e8 73 fc ff ff       	call   80103680 <myproc>
...
80103a1d:	74 4f                	je     80103a6e <sched+0x6e>
  if(mycpu()->ncli != 1)
80103a1f:	e8 bc fb ff ff       	call   801035e0 <mycpu>
...
80103a38:	75 40                	jne    80103a7a <sched+0x7a>
  intena = mycpu()->intena;
80103a3a:	e8 a1 fb ff ff       	call   801035e0 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103a3f:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103a42:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103a48:	e8 93 fb ff ff       	call   801035e0 <mycpu>
...
80103a57:	e8 5f 0a 00 00       	call   801044bb <swtch>
  mycpu()->intena = intena;
80103a5c:	e8 7f fb ff ff       	call   801035e0 <mycpu>
...
80103a6e:	c7 04 24 7d 73 10 80 	movl   $0x8010737d,(%esp)
80103a75:	e8 e6 c8 ff ff       	call   80100360 <panic>
    panic("sched interruptible");
80103a7a:	c7 04 24 a9 73 10 80 	movl   $0x801073a9,(%esp)
80103a81:	e8 da c8 ff ff       	call   80100360 <panic>
    panic("sched running");
80103a86:	c7 04 24 9b 73 10 80 	movl   $0x8010739b,(%esp)
80103a8d:	e8 ce c8 ff ff       	call   80100360 <panic>
    panic("sched locks");
80103a92:	c7 04 24 8f 73 10 80 	movl   $0x8010738f,(%esp)
...
80103aa7:	83 ec 10             	sub    $0x10,%esp
  struct proc *curproc = myproc();
80103aaa:	e8 d1 fb ff ff       	call   80103680 <myproc>
  if(curproc == initproc)
...
80103acb:	e8 30 d3 ff ff       	call   80100e00 <fileclose>
      curproc->ofile[fd] = 0;
...
80103ade:	75 e0                	jne    80103ac0 <exit+0x20>
  begin_op();
80103ae0:	e8 0b f0 ff ff       	call   80102af0 <begin_op>
  iput(curproc->cwd);
80103ae5:	8b 43 68             	mov    0x68(%ebx),%eax
80103ae8:	89 04 24             	mov    %eax,(%esp)
80103aeb:	e8 c0 dc ff ff       	call   801017b0 <iput>
  end_op();
80103af0:	e8 6b f0 ff ff       	call   80102b60 <end_op>
  curproc->cwd = 0;
...
80103b96:	e8 65 fe ff ff       	call   80103a00 <sched>
  panic("zombie exit");
80103b9b:	c7 04 24 ca 73 10 80 	movl   $0x801073ca,(%esp)
80103ba2:	e8 b9 c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103ba7:	c7 04 24 bd 73 10 80 	movl   $0x801073bd,(%esp)
...
80103bd2:	e8 a9 fa ff ff       	call   80103680 <myproc>
...
80103c0c:	8b 75 0c             	mov    0xc(%ebp),%esi
  struct proc *p = myproc();
80103c0f:	e8 6c fa ff ff       	call   80103680 <myproc>
  if(p == 0)
...
80103c8e:	c7 04 24 dc 73 10 80 	movl   $0x801073dc,(%esp)
80103c95:	e8 c6 c6 ff ff       	call   80100360 <panic>
    panic("sleep");
80103c9a:	c7 04 24 d6 73 10 80 	movl   $0x801073d6,(%esp)
...
80103cb5:	83 ec 10             	sub    $0x10,%esp
  struct proc *curproc = myproc();
80103cb8:	e8 c3 f9 ff ff       	call   80103680 <myproc>
  acquire(&ptable.lock);
...
80103d26:	e8 a5 e5 ff ff       	call   801022d0 <kfree>
        freevm(p->pgdir);
...
80103e84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e88:	c7 04 24 cb 77 10 80 	movl   $0x801077cb,(%esp)
...
80103eaa:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80103ead:	ba ed 73 10 80       	mov    $0x801073ed,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103eb2:	77 11                	ja     80103ec5 <procdump+0x55>
80103eb4:	8b 14 85 4c 74 10 80 	mov    -0x7fef8bb4(,%eax,4),%edx
      state = "???";
80103ebb:	b8 ed 73 10 80       	mov    $0x801073ed,%eax
...
80103ed0:	c7 04 24 f1 73 10 80 	movl   $0x801073f1,(%esp)
...
80103f4a:	c7 44 24 04 64 74 10 	movl   $0x80107464,0x4(%esp)
80103f51:	80 
...
80103fb2:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80103fb8:	e8 c3 f6 ff ff       	call   80103680 <myproc>
...
801040e5:	e8 f6 f4 ff ff       	call   801035e0 <mycpu>
...
80104119:	e8 c2 f4 ff ff       	call   801035e0 <mycpu>
8010411e:	81 e3 00 02 00 00    	and    $0x200,%ebx
80104124:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
8010412a:	e8 b1 f4 ff ff       	call   801035e0 <mycpu>
...
80104172:	e8 69 f4 ff ff       	call   801035e0 <mycpu>
...
8010419b:	e8 40 f4 ff ff       	call   801035e0 <mycpu>
  if(holding(lk))
...
801041a7:	eb ac                	jmp    80104155 <acquire+0x15>
    panic("acquire");
801041a9:	c7 04 24 6f 74 10 80 	movl   $0x8010746f,(%esp)
...
801041cb:	75 49                	jne    80104216 <popcli+0x56>
  ...
  if(--mycpu()->ncli < 0)
801041cd:	e8 0e f4 ff ff       	call   801035e0 <mycpu>
...
801041e5:	e8 f6 f3 ff ff       	call   801035e0 <mycpu>
...
801041f6:	66 90                	xchg   %ax,%ax
  if(mycpu()->ncli == 0 && mycpu()->intena)
801041f8:	e8 e3 f3 ff ff       	call   801035e0 <mycpu>
...
80104209:	c3                   	ret    
    panic("popcli");
8010420a:	c7 04 24 8e 74 10 80 	movl   $0x8010748e,(%esp)
80104211:	e8 4a c1 ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
80104216:	c7 04 24 77 74 10 80 	movl   $0x80107477,(%esp)
...
801044f9:	89 d0                	mov    %edx,%eax
801044fb:	89 11                	mov    %edx,(%ecx)
  //ep = (char*)curproc->sz;
  //for(s = *pp; s < ep; s++){
   // if(*s == 0)
//     return s = *pp;
...
80104500:	74 0e                	je     80104510 <fetchstr+0x20>
80104502:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
		s++;
80104508:	83 c0 01             	add    $0x1,%eax
	while(*s != 0){
8010450b:	80 38 00             	cmpb   $0x0,(%eax)
8010450e:	75 f8                	jne    80104508 <fetchstr+0x18>
	}
  
  return (s - *pp) - 1;
80104510:	29 d0                	sub    %edx,%eax
80104512:	83 e8 01             	sub    $0x1,%eax
}
80104515:	5d                   	pop    %ebp
80104516:	c3                   	ret    
...
80104553:	83 ec 08             	sub    $0x8,%esp
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104556:	e8 25 f1 ff ff       	call   80103680 <myproc>
...
80104583:	83 ec 08             	sub    $0x8,%esp
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104586:	e8 f5 f0 ff ff       	call   80103680 <myproc>
  *ip = *(int*)(addr);
...
80104597:	8b 54 90 04          	mov    0x4(%eax,%edx,4),%edx
  *pp = (char*)addr;
8010459b:	89 11                	mov    %edx,(%ecx)
8010459d:	89 d0                	mov    %edx,%eax
	while(*s != 0){
8010459f:	80 3a 00             	cmpb   $0x0,(%edx)
801045a2:	74 0c                	je     801045b0 <argstr+0x30>
801045a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
		s++;
801045a8:	83 c0 01             	add    $0x1,%eax
	while(*s != 0){
801045ab:	80 38 00             	cmpb   $0x0,(%eax)
801045ae:	75 f8                	jne    801045a8 <argstr+0x28>
  return (s - *pp) - 1;
801045b0:	29 d0                	sub    %edx,%eax
801045b2:	83 e8 01             	sub    $0x1,%eax
  int addr;
  if(argint(n, &addr) < 0)
    return -1;
...
80104606:	c7 04 24 9d 74 10 80 	movl   $0x8010749d,(%esp)
...
8010480a:	e8 11 fd ff ff       	call   80104520 <argint>
...
801048c2:	e8 59 fc ff ff       	call   80104520 <argint>
...
801048e0:	e8 6b fc ff ff       	call   80104550 <argptr>
...
80104932:	e8 e9 fb ff ff       	call   80104520 <argint>
...
80104950:	e8 fb fb ff ff       	call   80104550 <argptr>
...
801049ea:	e8 61 fb ff ff       	call   80104550 <argptr>
...
80104a27:	e8 54 fb ff ff       	call   80104580 <argstr>
...
80104a42:	e8 39 fb ff ff       	call   80104580 <argstr>
...
80104b47:	e8 34 fa ff ff       	call   80104580 <argstr>
...
80104bfe:	e8 7d f6 ff ff       	call   80104280 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80104d37:	e8 44 f8 ff ff       	call   80104580 <argstr>
...
80104d52:	e8 c9 f7 ff ff       	call   80104520 <argint>
...
80104e79:	e8 02 f7 ff ff       	call   80104580 <argstr>
...
80104ed9:	e8 a2 f6 ff ff       	call   80104580 <argstr>
...
80104ef0:	e8 2b f6 ff ff       	call   80104520 <argint>
  if((argstr(0, &path)) < 0 ||
...
80104f07:	e8 14 f6 ff ff       	call   80104520 <argint>
     argint(1, &major) < 0 ||
...
80104f72:	e8 09 f6 ff ff       	call   80104580 <argstr>
...
80104ffd:	e8 7e f5 ff ff       	call   80104580 <argstr>
...
8010501b:	e8 00 f5 ff ff       	call   80104520 <argint>
...
8010504b:	e8 30 f2 ff ff       	call   80104280 <memset>
    if(i >= NELEM(argv))
      return -1;
...
80105060:	e8 6b f4 ff ff       	call   801044d0 <fetchint>
...
8010507a:	e8 71 f4 ff ff       	call   801044f0 <fetchstr>
...
801050ed:	e8 5e f4 ff ff       	call   80104550 <argptr>
...
80105184:	e8 97 f3 ff ff       	call   80104520 <argint>
...
801051a3:	e8 a8 f3 ff ff       	call   80104550 <argptr>
...
801051b9:	e8 f2 1b 00 00       	call   80106db0 <shm_open>
}
801051be:	c9                   	leave  
801051bf:	c3                   	ret    
    return -1;
...
801051e4:	e8 37 f3 ff ff       	call   80104520 <argint>
...
801051f3:	e8 c8 1b 00 00       	call   80106dc0 <shm_close>
}
801051f8:	c9                   	leave  
801051f9:	c3                   	ret    
...
80105254:	e8 c7 f2 ff ff       	call   80104520 <argint>
...
801052a5:	e8 76 f2 ff ff       	call   80104520 <argint>
...
801052bb:	e8 30 e5 ff ff       	call   801037f0 <growproc>
...
80105305:	e8 36 ee ff ff       	call   80104140 <acquire>
  ticks0 = ticks;
...
80105353:	e8 d8 ee ff ff       	call   80104230 <release>
      return -1;
...
8010536f:	e8 bc ee ff ff       	call   80104230 <release>
}
...
80105466:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
8010546c:	e8 df eb ff ff       	call   80104050 <initlock>
}
80105471:	c9                   	leave  
80105472:	c3                   	ret    
...
801054c2:	0f 84 f8 01 00 00    	je     801056c0 <trap+0x210>
    if(myproc()->killed)
      exit();
    return;
  }
...
801054d0:	ff 24 85 4c 76 10 80 	jmp    *-0x7fef89b4(,%eax,4)
801054d7:	90                   	nop
			break;
		}
...
801054df:	90                   	nop
801054e0:	0f 84 62 02 00 00    	je     80105748 <trap+0x298>
801054e6:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
801054ea:	0f 84 58 02 00 00    	je     80105748 <trap+0x298>
...
80105543:	c7 04 24 08 76 10 80 	movl   $0x80107608,(%esp)
...
801055ab:	0f 84 38 01 00 00    	je     801056e9 <trap+0x239>
    exit();
}
...
801055f3:	e8 88 e0 ff ff       	call   80103680 <myproc>
801055f8:	89 74 24 08          	mov    %esi,0x8(%esp)
801055fc:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
80105602:	89 74 24 04          	mov    %esi,0x4(%esp)
80105606:	8b 40 04             	mov    0x4(%eax),%eax
80105609:	89 04 24             	mov    %eax,(%esp)
8010560c:	e8 0f 12 00 00       	call   80106820 <allocuvm>
80105611:	85 c0                	test   %eax,%eax
80105613:	0f 84 df 00 00 00    	je     801056f8 <trap+0x248>
				myproc()->pages++;
80105619:	e8 62 e0 ff ff       	call   80103680 <myproc>
8010561e:	83 40 7c 01          	addl   $0x1,0x7c(%eax)
				cprintf("page allocated\n");
80105622:	c7 04 24 86 75 10 80 	movl   $0x80107586,(%esp)
80105629:	e8 22 b0 ff ff       	call   80100650 <cprintf>
8010562e:	e9 2d ff ff ff       	jmp    80105560 <trap+0xb0>
80105633:	90                   	nop
80105634:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105638:	e8 23 e0 ff ff       	call   80103660 <cpuid>
8010563d:	85 c0                	test   %eax,%eax
8010563f:	90                   	nop
80105640:	0f 84 d2 00 00 00    	je     80105718 <trap+0x268>
    lapiceoi();
80105646:	e8 15 d1 ff ff       	call   80102760 <lapiceoi>
8010564b:	90                   	nop
8010564c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    break;
80105650:	e9 0b ff ff ff       	jmp    80105560 <trap+0xb0>
...
80105665:	e8 f6 d0 ff ff       	call   80102760 <lapiceoi>
    break;
8010566a:	e9 f1 fe ff ff       	jmp    80105560 <trap+0xb0>
8010566f:	90                   	nop
    uartintr();
...
80105675:	e8 e6 d0 ff ff       	call   80102760 <lapiceoi>
    break;
8010567a:	e9 e1 fe ff ff       	jmp    80105560 <trap+0xb0>
8010567f:	90                   	nop
...
8010568c:	c7 04 24 b0 75 10 80 	movl   $0x801075b0,(%esp)
...
801056a4:	eb a0                	jmp    80105646 <trap+0x196>
801056a6:	66 90                	xchg   %ax,%ax
    ideintr();
801056a8:	e8 b3 c9 ff ff       	call   80102060 <ideintr>
801056ad:	8d 76 00             	lea    0x0(%esi),%esi
    lapiceoi();
801056b0:	e8 ab d0 ff ff       	call   80102760 <lapiceoi>
    break;
801056b5:	e9 a6 fe ff ff       	jmp    80105560 <trap+0xb0>
...
801056ef:	5d                   	pop    %ebp
      exit();
801056f0:	e9 ab e3 ff ff       	jmp    80103aa0 <exit>
801056f5:	8d 76 00             	lea    0x0(%esi),%esi
				cprintf("page not allocated\n");
801056f8:	c7 04 24 96 75 10 80 	movl   $0x80107596,(%esp)
801056ff:	e8 4c af ff ff       	call   80100650 <cprintf>
				exit();
80105704:	e8 97 e3 ff ff       	call   80103aa0 <exit>
80105709:	e9 52 fe ff ff       	jmp    80105560 <trap+0xb0>
8010570e:	66 90                	xchg   %ax,%ax
      exit();
80105710:	e8 8b e3 ff ff       	call   80103aa0 <exit>
80105715:	eb b5                	jmp    801056cc <trap+0x21c>
80105717:	90                   	nop
      acquire(&tickslock);
80105718:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
8010571f:	e8 1c ea ff ff       	call   80104140 <acquire>
      wakeup(&ticks);
80105724:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
      ticks++;
8010572b:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
80105732:	e8 59 e6 ff ff       	call   80103d90 <wakeup>
      release(&tickslock);
80105737:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
8010573e:	e8 ed ea ff ff       	call   80104230 <release>
80105743:	e9 fe fe ff ff       	jmp    80105646 <trap+0x196>
80105748:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010574b:	8b 73 38             	mov    0x38(%ebx),%esi
8010574e:	e8 0d df ff ff       	call   80103660 <cpuid>
80105753:	89 7c 24 10          	mov    %edi,0x10(%esp)
80105757:	89 74 24 0c          	mov    %esi,0xc(%esp)
8010575b:	89 44 24 08          	mov    %eax,0x8(%esp)
8010575f:	8b 43 30             	mov    0x30(%ebx),%eax
80105762:	c7 04 24 d4 75 10 80 	movl   $0x801075d4,(%esp)
80105769:	89 44 24 04          	mov    %eax,0x4(%esp)
8010576d:	e8 de ae ff ff       	call   80100650 <cprintf>
      panic("trap");
80105772:	c7 04 24 aa 75 10 80 	movl   $0x801075aa,(%esp)
80105779:	e8 e2 ab ff ff       	call   80100360 <panic>
...
80105867:	00 
  for(p="xv6...\n"; *p; p++)
80105868:	bb 14 77 10 80       	mov    $0x80107714,%ebx
  ioapicenable(IRQ_COM1, 0);
...
801058b6:	6a 00                	push   $0x0
  jmp alltraps
801058b8:	e9 00 fb ff ff       	jmp    801053bd <alltraps>
...
801058bf:	6a 01                	push   $0x1
  jmp alltraps
801058c1:	e9 f7 fa ff ff       	jmp    801053bd <alltraps>
...
801058e3:	6a 05                	push   $0x5
  jmp alltraps
801058e5:	e9 d3 fa ff ff       	jmp    801053bd <alltraps>
...
801058ec:	6a 06                	push   $0x6
  jmp alltraps
801058ee:	e9 ca fa ff ff       	jmp    801053bd <alltraps>
...
801058f5:	6a 07                	push   $0x7
  jmp alltraps
801058f7:	e9 c1 fa ff ff       	jmp    801053bd <alltraps>
...
8010590c:	6a 0a                	push   $0xa
  jmp alltraps
8010590e:	e9 aa fa ff ff       	jmp    801053bd <alltraps>
...
80105913:	6a 0b                	push   $0xb
  jmp alltraps
80105915:	e9 a3 fa ff ff       	jmp    801053bd <alltraps>
...
8010591a:	6a 0c                	push   $0xc
  jmp alltraps
8010591c:	e9 9c fa ff ff       	jmp    801053bd <alltraps>
...
80105941:	6a 11                	push   $0x11
  jmp alltraps
80105943:	e9 75 fa ff ff       	jmp    801053bd <alltraps>
...
8010594a:	6a 12                	push   $0x12
  jmp alltraps
8010594c:	e9 6c fa ff ff       	jmp    801053bd <alltraps>
...
80105953:	6a 13                	push   $0x13
  jmp alltraps
80105955:	e9 63 fa ff ff       	jmp    801053bd <alltraps>
...
8010596e:	6a 16                	push   $0x16
  jmp alltraps
80105970:	e9 48 fa ff ff       	jmp    801053bd <alltraps>
...
80105977:	6a 17                	push   $0x17
  jmp alltraps
80105979:	e9 3f fa ff ff       	jmp    801053bd <alltraps>
...
80105980:	6a 18                	push   $0x18
  jmp alltraps
80105982:	e9 36 fa ff ff       	jmp    801053bd <alltraps>
...
80105989:	6a 19                	push   $0x19
  jmp alltraps
8010598b:	e9 2d fa ff ff       	jmp    801053bd <alltraps>
...
80105992:	6a 1a                	push   $0x1a
  jmp alltraps
80105994:	e9 24 fa ff ff       	jmp    801053bd <alltraps>
...
8010599b:	6a 1b                	push   $0x1b
  jmp alltraps
8010599d:	e9 1b fa ff ff       	jmp    801053bd <alltraps>
...
801059a4:	6a 1c                	push   $0x1c
  jmp alltraps
801059a6:	e9 12 fa ff ff       	jmp    801053bd <alltraps>
...
801059ad:	6a 1d                	push   $0x1d
  jmp alltraps
801059af:	e9 09 fa ff ff       	jmp    801053bd <alltraps>
...
801059b6:	6a 1e                	push   $0x1e
  jmp alltraps
801059b8:	e9 00 fa ff ff       	jmp    801053bd <alltraps>
...
801059bf:	6a 1f                	push   $0x1f
  jmp alltraps
801059c1:	e9 f7 f9 ff ff       	jmp    801053bd <alltraps>
...
801059c8:	6a 20                	push   $0x20
  jmp alltraps
801059ca:	e9 ee f9 ff ff       	jmp    801053bd <alltraps>
...
801059d1:	6a 21                	push   $0x21
  jmp alltraps
801059d3:	e9 e5 f9 ff ff       	jmp    801053bd <alltraps>
...
801059da:	6a 22                	push   $0x22
  jmp alltraps
801059dc:	e9 dc f9 ff ff       	jmp    801053bd <alltraps>
...
801059e3:	6a 23                	push   $0x23
  jmp alltraps
801059e5:	e9 d3 f9 ff ff       	jmp    801053bd <alltraps>
...
801059ec:	6a 24                	push   $0x24
  jmp alltraps
801059ee:	e9 ca f9 ff ff       	jmp    801053bd <alltraps>
...
801059f5:	6a 25                	push   $0x25
  jmp alltraps
801059f7:	e9 c1 f9 ff ff       	jmp    801053bd <alltraps>
...
801059fe:	6a 26                	push   $0x26
  jmp alltraps
80105a00:	e9 b8 f9 ff ff       	jmp    801053bd <alltraps>
...
80105a07:	6a 27                	push   $0x27
  jmp alltraps
80105a09:	e9 af f9 ff ff       	jmp    801053bd <alltraps>
...
80105a10:	6a 28                	push   $0x28
  jmp alltraps
80105a12:	e9 a6 f9 ff ff       	jmp    801053bd <alltraps>
...
80105a19:	6a 29                	push   $0x29
  jmp alltraps
80105a1b:	e9 9d f9 ff ff       	jmp    801053bd <alltraps>
...
80105a22:	6a 2a                	push   $0x2a
  jmp alltraps
80105a24:	e9 94 f9 ff ff       	jmp    801053bd <alltraps>
...
80105a2b:	6a 2b                	push   $0x2b
  jmp alltraps
80105a2d:	e9 8b f9 ff ff       	jmp    801053bd <alltraps>
...
80105a34:	6a 2c                	push   $0x2c
  jmp alltraps
80105a36:	e9 82 f9 ff ff       	jmp    801053bd <alltraps>
...
80105a3d:	6a 2d                	push   $0x2d
  jmp alltraps
80105a3f:	e9 79 f9 ff ff       	jmp    801053bd <alltraps>
...
80105a46:	6a 2e                	push   $0x2e
  jmp alltraps
80105a48:	e9 70 f9 ff ff       	jmp    801053bd <alltraps>
...
80105a4f:	6a 2f                	push   $0x2f
  jmp alltraps
80105a51:	e9 67 f9 ff ff       	jmp    801053bd <alltraps>
...
80105a58:	6a 30                	push   $0x30
  jmp alltraps
80105a5a:	e9 5e f9 ff ff       	jmp    801053bd <alltraps>
...
80105a61:	6a 31                	push   $0x31
  jmp alltraps
80105a63:	e9 55 f9 ff ff       	jmp    801053bd <alltraps>
...
80105a6a:	6a 32                	push   $0x32
  jmp alltraps
80105a6c:	e9 4c f9 ff ff       	jmp    801053bd <alltraps>
...
80105a73:	6a 33                	push   $0x33
  jmp alltraps
80105a75:	e9 43 f9 ff ff       	jmp    801053bd <alltraps>
...
80105a7c:	6a 34                	push   $0x34
  jmp alltraps
80105a7e:	e9 3a f9 ff ff       	jmp    801053bd <alltraps>
...
80105a85:	6a 35                	push   $0x35
  jmp alltraps
80105a87:	e9 31 f9 ff ff       	jmp    801053bd <alltraps>
...
80105a8e:	6a 36                	push   $0x36
  jmp alltraps
80105a90:	e9 28 f9 ff ff       	jmp    801053bd <alltraps>
...
80105a97:	6a 37                	push   $0x37
  jmp alltraps
80105a99:	e9 1f f9 ff ff       	jmp    801053bd <alltraps>
...
80105aa0:	6a 38                	push   $0x38
  jmp alltraps
80105aa2:	e9 16 f9 ff ff       	jmp    801053bd <alltraps>
...
80105aa9:	6a 39                	push   $0x39
  jmp alltraps
80105aab:	e9 0d f9 ff ff       	jmp    801053bd <alltraps>
...
80105ab2:	6a 3a                	push   $0x3a
  jmp alltraps
80105ab4:	e9 04 f9 ff ff       	jmp    801053bd <alltraps>
...
80105abb:	6a 3b                	push   $0x3b
  jmp alltraps
80105abd:	e9 fb f8 ff ff       	jmp    801053bd <alltraps>
...
80105ac4:	6a 3c                	push   $0x3c
  jmp alltraps
80105ac6:	e9 f2 f8 ff ff       	jmp    801053bd <alltraps>
...
80105acd:	6a 3d                	push   $0x3d
  jmp alltraps
80105acf:	e9 e9 f8 ff ff       	jmp    801053bd <alltraps>
...
80105ad6:	6a 3e                	push   $0x3e
  jmp alltraps
80105ad8:	e9 e0 f8 ff ff       	jmp    801053bd <alltraps>
...
80105adf:	6a 3f                	push   $0x3f
  jmp alltraps
80105ae1:	e9 d7 f8 ff ff       	jmp    801053bd <alltraps>
...
80105ae8:	6a 40                	push   $0x40
  jmp alltraps
80105aea:	e9 ce f8 ff ff       	jmp    801053bd <alltraps>
...
80105af1:	6a 41                	push   $0x41
  jmp alltraps
80105af3:	e9 c5 f8 ff ff       	jmp    801053bd <alltraps>
...
80105afa:	6a 42                	push   $0x42
  jmp alltraps
80105afc:	e9 bc f8 ff ff       	jmp    801053bd <alltraps>
...
80105b03:	6a 43                	push   $0x43
  jmp alltraps
80105b05:	e9 b3 f8 ff ff       	jmp    801053bd <alltraps>
...
80105b0c:	6a 44                	push   $0x44
  jmp alltraps
80105b0e:	e9 aa f8 ff ff       	jmp    801053bd <alltraps>
...
80105b15:	6a 45                	push   $0x45
  jmp alltraps
80105b17:	e9 a1 f8 ff ff       	jmp    801053bd <alltraps>
...
80105b1e:	6a 46                	push   $0x46
  jmp alltraps
80105b20:	e9 98 f8 ff ff       	jmp    801053bd <alltraps>
...
80105b27:	6a 47                	push   $0x47
  jmp alltraps
80105b29:	e9 8f f8 ff ff       	jmp    801053bd <alltraps>
...
80105b30:	6a 48                	push   $0x48
  jmp alltraps
80105b32:	e9 86 f8 ff ff       	jmp    801053bd <alltraps>
...
80105b39:	6a 49                	push   $0x49
  jmp alltraps
80105b3b:	e9 7d f8 ff ff       	jmp    801053bd <alltraps>
...
80105b42:	6a 4a                	push   $0x4a
  jmp alltraps
80105b44:	e9 74 f8 ff ff       	jmp    801053bd <alltraps>
...
80105b4b:	6a 4b                	push   $0x4b
  jmp alltraps
80105b4d:	e9 6b f8 ff ff       	jmp    801053bd <alltraps>
...
80105b54:	6a 4c                	push   $0x4c
  jmp alltraps
80105b56:	e9 62 f8 ff ff       	jmp    801053bd <alltraps>
...
80105b5d:	6a 4d                	push   $0x4d
  jmp alltraps
80105b5f:	e9 59 f8 ff ff       	jmp    801053bd <alltraps>
...
80105b66:	6a 4e                	push   $0x4e
  jmp alltraps
80105b68:	e9 50 f8 ff ff       	jmp    801053bd <alltraps>
...
80105b6f:	6a 4f                	push   $0x4f
  jmp alltraps
80105b71:	e9 47 f8 ff ff       	jmp    801053bd <alltraps>
...
80105b78:	6a 50                	push   $0x50
  jmp alltraps
80105b7a:	e9 3e f8 ff ff       	jmp    801053bd <alltraps>
...
80105b81:	6a 51                	push   $0x51
  jmp alltraps
80105b83:	e9 35 f8 ff ff       	jmp    801053bd <alltraps>
...
80105b8a:	6a 52                	push   $0x52
  jmp alltraps
80105b8c:	e9 2c f8 ff ff       	jmp    801053bd <alltraps>
...
80105b93:	6a 53                	push   $0x53
  jmp alltraps
80105b95:	e9 23 f8 ff ff       	jmp    801053bd <alltraps>
...
80105b9c:	6a 54                	push   $0x54
  jmp alltraps
80105b9e:	e9 1a f8 ff ff       	jmp    801053bd <alltraps>
...
80105ba5:	6a 55                	push   $0x55
  jmp alltraps
80105ba7:	e9 11 f8 ff ff       	jmp    801053bd <alltraps>
...
80105bae:	6a 56                	push   $0x56
  jmp alltraps
80105bb0:	e9 08 f8 ff ff       	jmp    801053bd <alltraps>
...
80105bb7:	6a 57                	push   $0x57
  jmp alltraps
80105bb9:	e9 ff f7 ff ff       	jmp    801053bd <alltraps>
...
80105bc0:	6a 58                	push   $0x58
  jmp alltraps
80105bc2:	e9 f6 f7 ff ff       	jmp    801053bd <alltraps>
...
80105bc9:	6a 59                	push   $0x59
  jmp alltraps
80105bcb:	e9 ed f7 ff ff       	jmp    801053bd <alltraps>
...
80105bd2:	6a 5a                	push   $0x5a
  jmp alltraps
80105bd4:	e9 e4 f7 ff ff       	jmp    801053bd <alltraps>
...
80105bdb:	6a 5b                	push   $0x5b
  jmp alltraps
80105bdd:	e9 db f7 ff ff       	jmp    801053bd <alltraps>
...
80105be4:	6a 5c                	push   $0x5c
  jmp alltraps
80105be6:	e9 d2 f7 ff ff       	jmp    801053bd <alltraps>
...
80105bed:	6a 5d                	push   $0x5d
  jmp alltraps
80105bef:	e9 c9 f7 ff ff       	jmp    801053bd <alltraps>
...
80105bf6:	6a 5e                	push   $0x5e
  jmp alltraps
80105bf8:	e9 c0 f7 ff ff       	jmp    801053bd <alltraps>
...
80105bff:	6a 5f                	push   $0x5f
  jmp alltraps
80105c01:	e9 b7 f7 ff ff       	jmp    801053bd <alltraps>
...
80105c08:	6a 60                	push   $0x60
  jmp alltraps
80105c0a:	e9 ae f7 ff ff       	jmp    801053bd <alltraps>
...
80105c11:	6a 61                	push   $0x61
  jmp alltraps
80105c13:	e9 a5 f7 ff ff       	jmp    801053bd <alltraps>
...
80105c1a:	6a 62                	push   $0x62
  jmp alltraps
80105c1c:	e9 9c f7 ff ff       	jmp    801053bd <alltraps>
...
80105c23:	6a 63                	push   $0x63
  jmp alltraps
80105c25:	e9 93 f7 ff ff       	jmp    801053bd <alltraps>
...
80105c2c:	6a 64                	push   $0x64
  jmp alltraps
80105c2e:	e9 8a f7 ff ff       	jmp    801053bd <alltraps>
...
80105c35:	6a 65                	push   $0x65
  jmp alltraps
80105c37:	e9 81 f7 ff ff       	jmp    801053bd <alltraps>
...
80105c3e:	6a 66                	push   $0x66
  jmp alltraps
80105c40:	e9 78 f7 ff ff       	jmp    801053bd <alltraps>
...
80105c47:	6a 67                	push   $0x67
  jmp alltraps
80105c49:	e9 6f f7 ff ff       	jmp    801053bd <alltraps>
...
80105c50:	6a 68                	push   $0x68
  jmp alltraps
80105c52:	e9 66 f7 ff ff       	jmp    801053bd <alltraps>
...
80105c59:	6a 69                	push   $0x69
  jmp alltraps
80105c5b:	e9 5d f7 ff ff       	jmp    801053bd <alltraps>
...
80105c62:	6a 6a                	push   $0x6a
  jmp alltraps
80105c64:	e9 54 f7 ff ff       	jmp    801053bd <alltraps>
...
80105c6b:	6a 6b                	push   $0x6b
  jmp alltraps
80105c6d:	e9 4b f7 ff ff       	jmp    801053bd <alltraps>
...
80105c74:	6a 6c                	push   $0x6c
  jmp alltraps
80105c76:	e9 42 f7 ff ff       	jmp    801053bd <alltraps>
...
80105c7d:	6a 6d                	push   $0x6d
  jmp alltraps
80105c7f:	e9 39 f7 ff ff       	jmp    801053bd <alltraps>
...
80105c86:	6a 6e                	push   $0x6e
  jmp alltraps
80105c88:	e9 30 f7 ff ff       	jmp    801053bd <alltraps>
...
80105c8f:	6a 6f                	push   $0x6f
  jmp alltraps
80105c91:	e9 27 f7 ff ff       	jmp    801053bd <alltraps>
...
80105c98:	6a 70                	push   $0x70
  jmp alltraps
80105c9a:	e9 1e f7 ff ff       	jmp    801053bd <alltraps>
...
80105ca1:	6a 71                	push   $0x71
  jmp alltraps
80105ca3:	e9 15 f7 ff ff       	jmp    801053bd <alltraps>
...
80105caa:	6a 72                	push   $0x72
  jmp alltraps
80105cac:	e9 0c f7 ff ff       	jmp    801053bd <alltraps>
...
80105cb3:	6a 73                	push   $0x73
  jmp alltraps
80105cb5:	e9 03 f7 ff ff       	jmp    801053bd <alltraps>
...
80105cbc:	6a 74                	push   $0x74
  jmp alltraps
80105cbe:	e9 fa f6 ff ff       	jmp    801053bd <alltraps>
...
80105cc5:	6a 75                	push   $0x75
  jmp alltraps
80105cc7:	e9 f1 f6 ff ff       	jmp    801053bd <alltraps>
...
80105cce:	6a 76                	push   $0x76
  jmp alltraps
80105cd0:	e9 e8 f6 ff ff       	jmp    801053bd <alltraps>
...
80105ce0:	6a 78                	push   $0x78
  jmp alltraps
80105ce2:	e9 d6 f6 ff ff       	jmp    801053bd <alltraps>
...
80105ce9:	6a 79                	push   $0x79
  jmp alltraps
80105ceb:	e9 cd f6 ff ff       	jmp    801053bd <alltraps>
...
80105cf2:	6a 7a                	push   $0x7a
  jmp alltraps
80105cf4:	e9 c4 f6 ff ff       	jmp    801053bd <alltraps>
...
80105d04:	6a 7c                	push   $0x7c
  jmp alltraps
80105d06:	e9 b2 f6 ff ff       	jmp    801053bd <alltraps>
...
80105d0d:	6a 7d                	push   $0x7d
  jmp alltraps
80105d0f:	e9 a9 f6 ff ff       	jmp    801053bd <alltraps>
...
80105d16:	6a 7e                	push   $0x7e
  jmp alltraps
80105d18:	e9 a0 f6 ff ff       	jmp    801053bd <alltraps>
...
8010644a:	c3                   	ret    
        panic("kfree");
8010644b:	c7 04 24 46 70 10 80 	movl   $0x80107046,(%esp)
...
80106591:	c3                   	ret    
      panic("remap");
80106592:	c7 04 24 1c 77 10 80 	movl   $0x8010771c,(%esp)
...
801066a1:	c7 04 24 22 77 10 80 	movl   $0x80107722,(%esp)
801066a8:	e8 b3 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
801066ad:	c7 04 24 4d 77 10 80 	movl   $0x8010774d,(%esp)
801066b4:	e8 a7 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
801066b9:	c7 04 24 38 77 10 80 	movl   $0x80107738,(%esp)
...
8010674e:	c7 04 24 61 77 10 80 	movl   $0x80107761,(%esp)
...
80106802:	c7 04 24 7b 77 10 80 	movl   $0x8010777b,(%esp)
80106809:	e8 52 9b ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
8010680e:	c7 04 24 40 78 10 80 	movl   $0x80107840,(%esp)
...
801068b2:	c7 04 24 99 77 10 80 	movl   $0x80107799,(%esp)
...
801068e0:	c7 04 24 b1 77 10 80 	movl   $0x801077b1,(%esp)
...
801069a3:	e9 28 b9 ff ff       	jmp    801022d0 <kfree>
    panic("freevm: no pgdir");
801069a8:	c7 04 24 cd 77 10 80 	movl   $0x801077cd,(%esp)
...
80106a8b:	c3                   	ret    
    panic("clearpteu");
80106a8c:	c7 04 24 de 77 10 80 	movl   $0x801077de,(%esp)
...
80106ab0:	89 45 dc             	mov    %eax,-0x24(%ebp)
80106ab3:	0f 84 82 01 00 00    	je     80106c3b <copyuvm+0x19b>
    return 0;
  for(i = 0; i < currproc->sz; i += PGSIZE){
80106ab9:	8b 45 08             	mov    0x8(%ebp),%eax
80106abc:	8b 10                	mov    (%eax),%edx
80106abe:	85 d2                	test   %edx,%edx
80106ac0:	0f 84 ba 00 00 00    	je     80106b80 <copyuvm+0xe0>
80106ac6:	31 db                	xor    %ebx,%ebx
80106ac8:	89 c7                	mov    %eax,%edi
80106aca:	eb 56                	jmp    80106b22 <copyuvm+0x82>
...
80106ada:	00 
80106adb:	89 34 24             	mov    %esi,(%esp)
80106ade:	05 00 00 00 80       	add    $0x80000000,%eax
80106ae3:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ae7:	e8 34 d8 ff ff       	call   80104320 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106aec:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106aef:	8d 96 00 00 00 80    	lea    -0x80000000(%esi),%edx
80106af5:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106af9:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106b00:	00 
80106b01:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106b05:	89 44 24 10          	mov    %eax,0x10(%esp)
80106b09:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106b0c:	89 04 24             	mov    %eax,(%esp)
80106b0f:	e8 0c fa ff ff       	call   80106520 <mappages>
80106b14:	85 c0                	test   %eax,%eax
80106b16:	78 4e                	js     80106b66 <copyuvm+0xc6>
  for(i = 0; i < currproc->sz; i += PGSIZE){
80106b18:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106b1e:	39 1f                	cmp    %ebx,(%edi)
80106b20:	76 5e                	jbe    80106b80 <copyuvm+0xe0>
    if((pte = walkpgdir(currproc->pgdir, (void *) i, 0)) == 0)
80106b22:	8b 47 04             	mov    0x4(%edi),%eax
80106b25:	31 c9                	xor    %ecx,%ecx
80106b27:	89 da                	mov    %ebx,%edx
80106b29:	e8 02 f8 ff ff       	call   80106330 <walkpgdir>
80106b2e:	85 c0                	test   %eax,%eax
80106b30:	0f 84 18 01 00 00    	je     80106c4e <copyuvm+0x1ae>
    if(!(*pte & PTE_P))
80106b36:	8b 30                	mov    (%eax),%esi
80106b38:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106b3e:	0f 84 fe 00 00 00    	je     80106c42 <copyuvm+0x1a2>
    pa = PTE_ADDR(*pte);
80106b44:	89 f0                	mov    %esi,%eax
    flags = PTE_FLAGS(*pte);
80106b46:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
    pa = PTE_ADDR(*pte);
80106b4c:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    flags = PTE_FLAGS(*pte);
80106b51:	89 75 e0             	mov    %esi,-0x20(%ebp)
    pa = PTE_ADDR(*pte);
80106b54:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80106b57:	e8 24 b9 ff ff       	call   80102480 <kalloc>
80106b5c:	85 c0                	test   %eax,%eax
80106b5e:	89 c6                	mov    %eax,%esi
80106b60:	0f 85 6a ff ff ff    	jne    80106ad0 <copyuvm+0x30>
			goto bad;
	}
  return d;
...
80106b6c:	e8 cf fd ff ff       	call   80106940 <freevm>
  return 0;
...
80106b7c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(i = 0; i < currproc->sz; i += PGSIZE){
80106b80:	bf 00 f0 ff 7f       	mov    $0x7ffff000,%edi
80106b85:	31 db                	xor    %ebx,%ebx
80106b87:	8b 75 08             	mov    0x8(%ebp),%esi
80106b8a:	e9 98 00 00 00       	jmp    80106c27 <copyuvm+0x187>
80106b8f:	90                   	nop
		if((pte = walkpgdir(currproc->pgdir, (void *) pg_addr, 0)) == 0)
80106b90:	8b 46 04             	mov    0x4(%esi),%eax
80106b93:	31 c9                	xor    %ecx,%ecx
80106b95:	89 fa                	mov    %edi,%edx
		uint pg_addr = STACKBASE - ((PGSIZE-1) * (i+1));
80106b97:	83 c3 01             	add    $0x1,%ebx
		if((pte = walkpgdir(currproc->pgdir, (void *) pg_addr, 0)) == 0)
80106b9a:	e8 91 f7 ff ff       	call   80106330 <walkpgdir>
80106b9f:	85 c0                	test   %eax,%eax
80106ba1:	0f 84 b3 00 00 00    	je     80106c5a <copyuvm+0x1ba>
		if(!(*pte & PTE_P))
80106ba7:	8b 00                	mov    (%eax),%eax
80106ba9:	a8 01                	test   $0x1,%al
80106bab:	0f 84 b5 00 00 00    	je     80106c66 <copyuvm+0x1c6>
		pa = PTE_ADDR(*pte);
80106bb1:	89 c1                	mov    %eax,%ecx
		flags = PTE_FLAGS(*pte);
80106bb3:	25 ff 0f 00 00       	and    $0xfff,%eax
		pa = PTE_ADDR(*pte);
80106bb8:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
80106bbe:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
		flags = PTE_FLAGS(*pte);
80106bc1:	89 45 e0             	mov    %eax,-0x20(%ebp)
		if((mem = kalloc()) == 0)
80106bc4:	e8 b7 b8 ff ff       	call   80102480 <kalloc>
80106bc9:	85 c0                	test   %eax,%eax
80106bcb:	89 c2                	mov    %eax,%edx
80106bcd:	74 97                	je     80106b66 <copyuvm+0xc6>
		memmove(mem, (char*)P2V(pa), PGSIZE);
80106bcf:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106bd2:	89 14 24             	mov    %edx,(%esp)
80106bd5:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106bdc:	00 
80106bdd:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80106be0:	05 00 00 00 80       	add    $0x80000000,%eax
80106be5:	89 44 24 04          	mov    %eax,0x4(%esp)
80106be9:	e8 32 d7 ff ff       	call   80104320 <memmove>
		if(mappages(d, (void*)pg_addr, PGSIZE, V2P(mem), flags) < 0)
80106bee:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106bf1:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106bf4:	89 7c 24 04          	mov    %edi,0x4(%esp)
80106bf8:	81 ef ff 0f 00 00    	sub    $0xfff,%edi
80106bfe:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106c05:	00 
80106c06:	89 44 24 10          	mov    %eax,0x10(%esp)
80106c0a:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106c0d:	81 c2 00 00 00 80    	add    $0x80000000,%edx
80106c13:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106c17:	89 04 24             	mov    %eax,(%esp)
80106c1a:	e8 01 f9 ff ff       	call   80106520 <mappages>
80106c1f:	85 c0                	test   %eax,%eax
80106c21:	0f 88 3f ff ff ff    	js     80106b66 <copyuvm+0xc6>
	for(i = 0; i<currproc->pages; i++){
80106c27:	3b 5e 7c             	cmp    0x7c(%esi),%ebx
80106c2a:	0f 82 60 ff ff ff    	jb     80106b90 <copyuvm+0xf0>
...
80106c3d:	e9 31 ff ff ff       	jmp    80106b73 <copyuvm+0xd3>
      panic("copyuvm: page not present");
80106c42:	c7 04 24 02 78 10 80 	movl   $0x80107802,(%esp)
80106c49:	e8 12 97 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106c4e:	c7 04 24 e8 77 10 80 	movl   $0x801077e8,(%esp)
80106c55:	e8 06 97 ff ff       	call   80100360 <panic>
			panic("copyuvm: pte should exsit\n");
80106c5a:	c7 04 24 1c 78 10 80 	movl   $0x8010781c,(%esp)
80106c61:	e8 fa 96 ff ff       	call   80100360 <panic>
			panic("panci\n");
80106c66:	c7 04 24 37 78 10 80 	movl   $0x80107837,(%esp)
...
80106c8e:	e8 9d f6 ff ff       	call   80106330 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106d56:	c7 44 24 04 64 78 10 	movl   $0x80107864,0x4(%esp)
80106d5d:	80 
80106d5e:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106d65:	e8 e6 d2 ff ff       	call   80104050 <initlock>
  acquire(&(shm_table.lock));
80106d6a:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106d71:	e8 ca d3 ff ff       	call   80104140 <acquire>
80106d76:	b8 f4 55 11 80       	mov    $0x801155f4,%eax
80106d7b:	90                   	nop
80106d7c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for (i = 0; i< 64; i++) {
    shm_table.shm_pages[i].id =0;
80106d80:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80106d86:	83 c0 0c             	add    $0xc,%eax
    shm_table.shm_pages[i].frame =0;
80106d89:	c7 40 f8 00 00 00 00 	movl   $0x0,-0x8(%eax)
    shm_table.shm_pages[i].refcnt =0;
80106d90:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
  for (i = 0; i< 64; i++) {
80106d97:	3d f4 58 11 80       	cmp    $0x801158f4,%eax
80106d9c:	75 e2                	jne    80106d80 <shminit+0x30>
  }
  release(&(shm_table.lock));
80106d9e:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106da5:	e8 86 d4 ff ff       	call   80104230 <release>
}
80106daa:	c9                   	leave  
80106dab:	c3                   	ret    
